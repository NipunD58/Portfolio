...
const photoFiles = ["DSCN0978.JPG", "DSCN0988.JPG", "DSCN1074.JPG", "DSCN4814.JPG", "DSCN4871.JPG", "DSCN4959.JPG", "DSCN4962.JPG", "DSCN4963.JPG", "DSCN1003.JPG"];
...
function PhotographyPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative min-h-screen text-foreground", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative flex min-h-screen items-center px-6 pt-32 md:px-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SectionLabel, { children: "Photography" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: isLightboxOpen, onOpenChange: (open) => {
      if (!open) setActivePhoto(null);
    }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogContent, { className: "w-[min(92vw,1200px)] max-w-[92vw] border-border bg-background/95 p-0 overflow-hidden", children: activePhoto && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-b border-border px-6 py-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono-label text-muted-foreground", children: "Photograph" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 font-display text-2xl text-foreground", children: activePhoto.title }),
        (activePhoto.location || activePhoto.year) && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono-label mt-2 text-muted-foreground", children: [activePhoto.location, activePhoto.year].filter(Boolean).join(" · ") })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-black/90 p-4 md:p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: activePhoto.src ?? "", alt: activePhoto.alt ?? activePhoto.title, className: "photo-image max-h-[75vh] w-full object-contain", loading: "eager" }) })
    ] }) }) })
  ] });
}
export {
