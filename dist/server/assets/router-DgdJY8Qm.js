...
const appCss = "/assets/styles-BPa1s4D1.css";
...
const getSeo = ({ title, description, path, ogType = "website" }) => {
  const ogImage = void 0;
...
const Route2 = createFileRoute("/")({
  ...
  head: () => getSeo({
    ...
    description: "Selectively skilled product designer with strong focus on producing high quality & impactful digital experience.",
    path: "/"
  })
});
