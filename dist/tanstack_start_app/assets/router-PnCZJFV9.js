...
const appCss = "/assets/styles-Dg8fjrx0.css";
...
const Route$3 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Selectively skilled product designer with strong focus on producing high quality & impactful digital experience." },
      { name: "author", content: "Nipun Dhawan" },
      { property: "og:title", content: "Nipun Dhawan — Making good shit since 2009" },
      { property: "og:description", content: "Selectively skilled product designer." },
...
const __vite_glob_0_0 = "/assets/DSCN0978-DSkxXHQv.JPG";
const __vite_glob_0_1 = "/assets/DSCN0988-De2wASUs.JPG";
const __vite_glob_0_2 = "/assets/DSCN1003-D5V30kz6.JPG";
const __vite_glob_0_3 = "/assets/DSCN1074-C5K9Eh5Z.JPG";
const __vite_glob_0_4 = "/assets/DSCN4814-Bj3pTkl9.JPG";
const __vite_glob_0_5 = "/assets/DSCN4871-CnwwZ5wP.JPG";
const __vite_glob_0_6 = "/assets/DSCN4904-XHrMmczs.JPG";
const __vite_glob_0_7 = "/assets/DSCN4959-CS4r7V7q.JPG";
const __vite_glob_0_8 = "/assets/DSCN4962-C16TYF65.JPG";
const __vite_glob_0_9 = "/assets/DSCN4963-DLtq8MXy.JPG";
function BlueCursor() {
...
const photoModules = /* @__PURE__ */ Object.assign({
  "../photos/DSCN0978.JPG": __vite_glob_0_0,
  "../photos/DSCN0988.JPG": __vite_glob_0_1,
  "../photos/DSCN1003.JPG": __vite_glob_0_2,
  "../photos/DSCN1074.JPG": __vite_glob_0_3,
  "../photos/DSCN4814.JPG": __vite_glob_0_4,
  "../photos/DSCN4871.JPG": __vite_glob_0_5,
  "../photos/DSCN4904.JPG": __vite_glob_0_6,
  "../photos/DSCN4959.JPG": __vite_glob_0_7,
  "../photos/DSCN4962.JPG": __vite_glob_0_8,
  "../photos/DSCN4963.JPG": __vite_glob_0_9
});
...
function PhotographyPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative min-h-screen text-foreground", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative flex min-h-screen items-center px-6 pt-32 md:px-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SectionLabel$2, { children: "Photography" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "mt-8 font-display text-[12vw] leading-[0.9] md:text-[8vw]", children: [
        "moments in ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("em", { className: "text-primary", children: "light" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-8 max-w-2xl text-lg text-muted-foreground md:text-xl", children: "A running collection of photographs." })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "border-t border-border px-6 py-24 md:px-12 md:py-32", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-12 md:grid-cols-[1fr_2fr]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SectionLabel$2, { children: "Selected shots" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-16 grid gap-px border border-border bg-border md:grid-cols-2 lg:grid-cols-3", children: photos.map((photo, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group bg-background/80 p-6 backdrop-blur-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-[4/5] overflow-hidden rounded-xl border border-border bg-muted/40", children: photo.src ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
            src: photo.src,
        ...
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-full items-center justify-center text-center text-muted-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono-label", children: "Add photograph" }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display text-2xl text-foreground", children: photo.title }),
          (photo.location || photo.year) && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono-label mt-2 text-muted-foreground", children: [photo.location, photo.year].filter(Boolean).join(" · ") })
        ] })
      ] }, `${photo.title}-${index}`)) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t border-border px-6 py-16 md:px-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-between gap-4 md:flex-row", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono-label text-muted-foreground", children: "© Nipun Dhawan — Photography" }),
...
function BlogPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative min-h-screen text-foreground", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative flex min-h-screen items-center px-6 pt-32 md:px-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SectionLabel$1, { children: "Blog" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "mt-8 font-display text-[12vw] leading-[0.9] md:text-[8vw]", children: [
        "thoughts, ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "border-t border-border px-6 py-24 md:px-12 md:py-32", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-12 md:grid-cols-[1fr_2fr]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SectionLabel$1, { children: "Latest" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-16 grid gap-12", children: articles.map((article, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-5 flex flex-wrap gap-2", children: article.tags.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "border-t border-border px-6 py-24 md:px-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-12 md:grid-cols-[1fr_2fr]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SectionLabel$1, { children: "Write" }),
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: `relative z-10 m-4 max-h-[88vh] w-full max-w-4xl overflow-y-auto rounded-2xl border border-border bg-background shadow-2xl transition-all duration-300 ${open ? "translate-y-0" : "translate-y-8"}`,
            children: article && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-8 md:p-12", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 flex flex-wrap gap-2", children: article.tags.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  className: "rounded-full border border-border px-3 py-1 text-xs uppercase tracking-widest text-muted-foreground",
                  children: tag
              ...
              article.images && article.images.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 grid gap-6", children: article.images.map((image, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "figure",
                {
...
const PhotographyRoute = Route$2.update({
  id: "/photography",
  path: "/photography",
